...
class BeforeAppLaunch(tank.Hook):
    ...
    def execute(self, app_path, app_args, version, **kwargs):
        ...
        if os.name == 'nt':
            src_path = 'N:\\application_support\\hiero\\shotgun_shot_export.xml'
            dst_path = '{0}\\.nuke\\TaskPresets\\Processors\\tk_hiero_export.sg_shot_processor.ShotgunShotProcessor' \
                .format(os.environ['USERPROFILE'])
        else:
            src_path = '/studio/application_support/hiero/shotgun_shot_export.xml'
            dst_path = '{0}/.nuke/TaskPresets/Processors/tk_hiero_export.sg_shot_processor.ShotgunShotProcessor' \
